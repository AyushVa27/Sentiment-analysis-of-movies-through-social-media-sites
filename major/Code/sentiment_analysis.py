...
#from sklearn.cross_validation import KFold as kFold2
...
if __name__ == "__main__":
    ...
    if args.Crossvalidation == "no" or args.Crossvalidation == "No":
        ...
        elif args.DataSetName == "movie_name":
            ayush=input("enter file name:")
            classify_twitter_data(file_name=ayush)
        ...
        elif args.DataSetName == "superman":
            classify_twitter_data(file_name="superman.txt")
        else:
    ...
    if args.Crossvalidation == "yes" or args.Crossvalidation == "Yes":
        cv_kFold = sklearn.cross_validation.KFold(len(data_X), 10, True, 5)
        i = 0
